...
def test_transceiver_power_range():
    ...
    trx_lib = {
        ...
        "Transceiver": [{
            ...
            "mode": [{
                ...
                "rx-channel-power-min-dbm": -29,
                "rx-channel-power-max-dbm": -19,
                "rx-ref-channel-power-dbm": -20,
                "penalties": [{
                    "rx_power": -20,
                    "penalty_value": 0
                }, {
    ...
    assert rq.rx_channel_power_min_dbm == -29
    assert rq.rx_channel_power_max_dbm == -19
