...
@pytest.mark.parametrize('case, site_type, amplifier_type, expected_design_bands, expected_per_degree_design_bands', [
    ('monoband_no_design_band', 'Edfa', 'Edfa',
     [{'f_min': 191.35e12, 'f_max': 196.1e12, 'spacing': 50e9}], [{'f_min': 191.35e12, 'f_max': 196.1e12, 'spacing': 50e9}]),  # noqa E501
    ('monoband_roadm', 'Edfa', 'Edfa',
     [{'f_min': 192.35e12, 'f_max': 196.0e12, 'spacing': 50e9}], [{'f_min': 192.35e12, 'f_max': 196.0e12, 'spacing': 50e9}]),  # noqa E501
    ('monoband_per_degree', 'Edfa', 'Edfa',
     [{'f_min': 191.35e12, 'f_max': 196.1e12, 'spacing': 50e9}], [{'f_min': 191.5e12, 'f_max': 195.0e12, 'spacing': 50e9}]),  # noqa E501
    ('monoband_design', 'Edfa', 'Edfa',
     [{'f_min': 191.35e12, 'f_max': 196.1e12, 'spacing': 50e9}], [{'f_min': 191.35e12, 'f_max': 196.1e12, 'spacing': 50e9}]),  # noqa E501
    ('design', 'Fused', 'Multiband_amplifier',
     [{'f_min': 191.35e12, 'f_max': 196.1e12, 'spacing': 50e9}],
     [{'f_min': 186.55e12, 'f_max': 190.05e12, 'spacing': 50e9}, {'f_min': 191.25e12, 'f_max': 196.15e12, 'spacing': 50e9}]),  # noqa E501
    ('no_design', 'Fused', 'Multiband_amplifier',
     [{'f_min': 191.35e12, 'f_max': 196.1e12, 'spacing': 50e9}],
     [{'f_min': 187.0e12, 'f_max': 190.0e12, 'spacing': 50e9}, {'f_min': 191.35e12, 'f_max': 196.0e12, 'spacing': 50e9}])])  # noqa E501
