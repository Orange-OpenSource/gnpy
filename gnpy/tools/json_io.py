...
def _spectrum_from_json(json_data: dict):
    ...
    ...     print(f'{k}: {v}')
    ...
    193200000000000.0: Carrier(delta_pdb=1, baud_rate=32000000000.0, slot_width=50000000000.0, roll_off=0.15, tx_osnr=45, tx_power=0.00019952623149688798, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='0-32.00G')
    193250000000000.0: Carrier(delta_pdb=1, baud_rate=32000000000.0, slot_width=50000000000.0, roll_off=0.15, tx_osnr=45, tx_power=0.00019952623149688798, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='0-32.00G')
    193300000000000.0: Carrier(delta_pdb=1, baud_rate=32000000000.0, slot_width=50000000000.0, roll_off=0.15, tx_osnr=45, tx_power=0.00019952623149688798, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='0-32.00G')
    193350000000000.0: Carrier(delta_pdb=1, baud_rate=32000000000.0, slot_width=50000000000.0, roll_off=0.15, tx_osnr=45, tx_power=0.00019952623149688798, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='0-32.00G')
    193400000000000.0: Carrier(delta_pdb=1, baud_rate=32000000000.0, slot_width=50000000000.0, roll_off=0.15, tx_osnr=45, tx_power=0.00019952623149688798, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='0-32.00G')
    193462500000000.0: Carrier(delta_pdb=0, baud_rate=64000000000.0, slot_width=75000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='1-64.00G')
    193537500000000.0: Carrier(delta_pdb=0, baud_rate=64000000000.0, slot_width=75000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='1-64.00G')
    193612500000000.0: Carrier(delta_pdb=0, baud_rate=64000000000.0, slot_width=75000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='1-64.00G')
    193687500000000.0: Carrier(delta_pdb=0, baud_rate=64000000000.0, slot_width=75000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='1-64.00G')
    193762500000000.0: Carrier(delta_pdb=0, baud_rate=64000000000.0, slot_width=75000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='1-64.00G')
    193837500000000.0: Carrier(delta_pdb=0, baud_rate=64000000000.0, slot_width=75000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='1-64.00G')
    193912500000000.0: Carrier(delta_pdb=0, baud_rate=64000000000.0, slot_width=75000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='1-64.00G')
    193987500000000.0: Carrier(delta_pdb=0, baud_rate=64000000000.0, slot_width=75000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='1-64.00G')
    194075000000000.0: Carrier(delta_pdb=0, baud_rate=90000000000.0, slot_width=100000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='2-90.00G')
    194200000000000.0: Carrier(delta_pdb=0, baud_rate=32000000000.0, slot_width=50000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='3-32.00G')
    194250000000000.0: Carrier(delta_pdb=0, baud_rate=32000000000.0, slot_width=50000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='3-32.00G')
    194300000000000.0: Carrier(delta_pdb=0, baud_rate=32000000000.0, slot_width=50000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='3-32.00G')
    194350000000000.0: Carrier(delta_pdb=0, baud_rate=32000000000.0, slot_width=50000000000.0, roll_off=0.15, tx_osnr=40, tx_power=0.001, required_osnr_db_01nm=None, penalties={}, rx_channel_power_min_dbm=None, rx_channel_power_max_dbm=None, detailed_rx=None, label='3-32.00G')
    """
    spectrum = {}
    ...
    for index, part in enumerate(json_data):
        ...
        for current_freq in arange(part['f_min'],
            ...
            spectrum[current_freq] = Carrier(delta_pdb=part['delta_pdb'], baud_rate=part['baud_rate'],
                                             ...
                                             detailed_rx=part.get('detailed_rx', None), label=part['label'])
